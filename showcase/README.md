...
* JBoss Business-Central Workbench 7.28.0.Final
...
To run a container:
    ...
    sudo podman run -p 8080:8080 -p 8001:8001 -d --name jbpm-workbench jboss/business-central-workbench-showcase:latest
...
3.- Create your Docker image:
    ...
    sudo podman build --rm -t jboss/business-central-workbench-showcase:MY_TAG
...
In order to keep the git repositories between different containers you can just start the container by configuring a new host volume as:
    ...
    # Use -v <SOURCE_FS_PATH>:<CONTAINER_FS_PATH>
    sudo podman run -p 8080:8080 -p 8001:8001 -v /home/myuser/wb_git:/opt/jboss/wildfly/mygit:Z -d --name business-central-workbench jboss/business-central-workbench-showcase:MY_TAG
...
To spin up a shell in one of the containers try:
    ...
    sudo podman run -t -i -p 8080:8080 -p 8001:8001 jboss/busines-central-workbench-showcase:latest /bin/bash
...
* JBoss Business-Central Workbench version is `7.28.0.Final`
...
* See release notes for [JBoss Business-Central](http://docs.jboss.org/jbpm/release/7.28.0.Final/jbpm-docs/html_single/#_jbpmreleasenotes)
