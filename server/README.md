...
* jBPM Workbench 7.28.0.Final
* KIE Server 7.28.0.Final
* jBPM Case Management Showcase 7.28.0.Final
...
To run a container:
    ...
    sudo podman run -p 8080:8080 -p 8001:8001 -d --name jbpm-server-full jboss/jbpm-server-full:latest
...
### MySQL Example
    ...
    sudo podman run -p 8080:8080 -p 8001:8001 -d --name jbpm-server-full -e JBPM_DB_DRIVER=mysql -e JBPM_DB_HOST=172.17.0.1 jboss/jbpm-server-full:latest

### PostgreSQL Example

    sudo podman run -p 8080:8080 -p 8001:8001 -d --name jbpm-server-full -e JBPM_DB_DRIVER=postgres -e JBPM_DB_HOST=172.17.0.1 jboss/jbpm-server-full:latest
...
To spin up a shell in one of the containers try:
    ...
    sudo podman run -t -i -p 8080:8080 -p 8001:8001 jboss/jbpm-server-full:latest /bin/bash
...
* See release notes for [jBPM](http://docs.jboss.org/jbpm/release/7.28.0.Final/jbpm-docs/html_single/#_jbpmreleasenotes)
