...
* jBPM Workbench version is `7.74.1.Final`
...
* jBPM Case Management Showcase version is `7.74.1.Final`
...
* See release notes for [jBPM](http://docs.jboss.org/jbpm/release/7.74.1.Final/jbpm-docs/html_single/#_jbpmreleasenotes)
