...
image_jbpm_workbench=$(podman run -P -d --network=host --name $CONTAINER_NAME $IMAGE_NAME:$IMAGE_TAG)
...
echo "jBPM Workbench is running at http://localhost:8080/business-central"
echo "KIE Server Swagger documentation is running at http://localhost:8080/kie-server/docs"
echo "jBPM Case Management Showcase is running at http://localhost:8080/jbpm-casemgmt"
