...
1.- copy the whole dir https://github.com/jboss-dockerfiles/business-central/tree/7.74.0.Final/showcase/etc/kie-fs-realm-users to<br>
...
2.- copy the file https://github.com/jboss-dockerfiles/business-central/blob/7.74.0.Final/showcase/etc/jbpm-custom.cli to<br>
$JBOSS_HOME/bin/
