...
* KIE Business-Central Workbench 7.64.0.Final
...
1.- copy the whole dir https://github.com/kiegroup/business-central/tree/7.64.0.Final/showcase/etc/kie-fs-realm-users to<br>
...
2.- copy the file https://github.com/mbiarnes/business-central/blob/7.64.0.Final/showcase/etc/jbpm-custom.cli to<br>
$JBOSS_HOME/bin/
...
* KIE Business-Central Workbench version is `7.64.0.Final`
...
* See release notes for [Business-Central](http://docs.jboss.org/jbpm/release/7.64.0.Final/jbpm-docs/html_single/#_jbpmreleasenotes)
