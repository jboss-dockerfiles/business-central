...
To run a container:
    ...
    sudo podman run -p 8080:8080 -p 8001:8001 -d --name business-central-workbench jboss/business-central-workbench:latest
...
To spin up a shell in one of the containers try:
    ...
    sudo podman run -t -i -p 8080:8080 -p 8001:8001 jboss/business-central-workbench:latest /bin/bash
