...
More information of KIE Server available at [KIE documentation](http://docs.jboss.org/drools/release/7.64.0.Final/drools-docs/html_single/#_ch.kie.server).
...
* KIE Server version is `7.64.0.Final`
