...
More information of KIE Server available at [JBoss documentation](https://docs.jboss.org/drools/release/7.24.0.Final/drools-docs/html_single/#_ch.kie.server).
...
* Drools KIE Server version is `7.24.0.Final`
...
* See release notes for [KIE-server](https://docs.jboss.org/drools/release/7.24.0.Final/drools-docs/html_single/index.html#_ch.kie.server)
