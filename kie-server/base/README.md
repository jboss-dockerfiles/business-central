...
More information of KIE Server available at [KIE documentation](https://docs.jboss.org/drools/release/7.73.0.Final/drools-docs/html_single/#_ch.kie.server).
...
* Drools KIE Server version is `7.73.0.Final`
...
* See release notes for [KIE-server](https://docs.jboss.org/drools/release/7.73.0.Final/drools-docs/html_single/index.html#_ch.kie.server)
