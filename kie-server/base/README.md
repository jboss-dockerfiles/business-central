...
More information of KIE Server available at [KIE documentation](https://docs.jboss.org/drools/release/7.74.1.Final/drools-docs/html_single/#_ch.kie.server).
...
* Drools KIE Server version is `7.74.1.Final`
